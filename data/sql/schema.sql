...
ALTER TABLE daystat ADD CONSTRAINT daystat_task_id_task_id FOREIGN KEY (task_id) REFERENCES task(id) ON DELETE CASCADE;
ALTER TABLE task ADD CONSTRAINT task_taskgroup_id_task_group_id FOREIGN KEY (taskgroup_id) REFERENCES task_group(id) ON DELETE CASCADE;
ALTER TABLE task_group ADD CONSTRAINT task_group_user_id_sf_guard_user_id FOREIGN KEY (user_id) REFERENCES sf_guard_user(id) ON DELETE CASCADE;
ALTER TABLE uow ADD CONSTRAINT uow_task_id_task_id FOREIGN KEY (task_id) REFERENCES task(id) ON DELETE CASCADE;
