...
/**
 * sfGuardUserProfileStuff filter form base class.
 *
 * @package    boetticher
 * @subpackage filter
 ...
 */
abstract class BasesfGuardUserProfileStuffFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('sf_guard_user_profile_stuff_filters[%s]');
