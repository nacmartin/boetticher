...
/**
 * nmGuardStuffUser filter form base class.
 *
 * @package    boetticher
 * @subpackage filter
 ...
 */
abstract class BasenmGuardStuffUserFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('nm_guard_stuff_user_filters[%s]');
